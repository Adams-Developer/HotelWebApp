...
namespace HotelWebApplication.Data.Migrations
{
    public partial class InitialTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //        ProfilePicture = table.Column<string>(type: "varchar(200)", nullable: true)
            //    },
            //    constraints: table =>
            //    {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomFeature_Features_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemImage", x => new { x.ItemId, x.ImageId });
                    table.ForeignKey(
